                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg sm:rounded-xl overflow-hidden shadow-sm p-4 sm:p-6">
                                <div className="space-y-2 sm:space-y-3">
                                    {feeStructure.ssc.individual.map((item, index) => (
                                        <div
                                            key={index}
                                            className={`flex justify-between items-center ${index !== feeStructure.ssc.individual.length - 1
                                                ? "border-b pb-2"
                                                : ""
                                                }`}
                                        >
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg sm:rounded-xl overflow-hidden shadow-sm p-4 sm:p-6">
                                <div className="space-y-2 sm:space-y-3">
                                    {feeStructure.hsc.individual.map((item, index) => (
                                        <div
                                            key={index}
                                            className={`flex justify-between items-center ${index !== feeStructure.hsc.individual.length - 1
                                                ? "border-b pb-2"
                                                : ""
                                                }`}
                                        >
