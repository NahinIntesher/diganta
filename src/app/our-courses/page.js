            ...
            {[
              {
                ...
                bio: "৫ বছর শিক্ষকতার অভিজ্ঞতা, বিশেষজ্ঞ মার্কেটিং কৌশলে",
              },
              {
                name: "মোঃ শুভ",
                subject: "মার্কেটিং বিভাগ",
                ...
                bio: "ব্যবসায় শিক্ষা ও মার্কেটিং কৌশলে বিশেষজ্ঞ",
              },
              {
                name: "এরফান হোসেন রিয়াজ",
                subject: "ইলেক্ট্রিক্যাল ইঞ্জিনিয়ারিং",
              ...
              {
                name: "ফয়সাল আহমেদ",
                subject: "কম্পিউটার সায়েন্স",
                qualification: "ইস্ট ওয়েস্ট ইউনিভার্সিটি",
                image: "/images/faisal.jpg",
                bio: "২ বছর শিক্ষকতার অভিজ্ঞতা, প্রোগ্রামিং ও ডিজিটাল লিটারেসি বিশেষজ্ঞ",
              },
              {
                name: "নাহিন ইনতিশার",
                subject: "কম্পিউটার সায়েন্স",
                ...
                bio: "এআই ও ডেটা সায়েন্সে পারদর্শী",
              },
              {
                name: "নাম",
                subject: "বিভাগ",
                qualification: "বিশ্ববিদ্যালয়",
                image: "/images/teacherx.jpg",
                bio: "অভিজ্ঞতা, বিশেষ পারদর্শিতা",
              },
            ].map((teacher, index) => (
              <motion.div
                key={index}
