            ...
            {[
              {
                title: "যোগাযোগ করুন",
                description:
                  "আমাদের হটলাইন নম্বরে কল করুন অথবা হোয়াটসঅ্যাপ করে যেকোনো তথ্য জেনে নিন",
                icon: FaPhone,
              },
              {
                title: "ফ্রি কাউন্সেলিং সেশন",
                description:
                  "আপনার সন্তানের প্রয়োজন অনুযায়ী সঠিক কোর্স বা ভর্তি বিষয় নির্বাচনে পরামর্শ নিন",
                icon: MessageSquare,
              },
              {
                title: "ভর্তি ফরম পূরণ",
                description:
                  "আমাদের কোচিং এ এসে প্রয়োজনীয় তথ্য দিয়ে ভর্তি ফরম পূরণ করুন",
                icon: FaBook,
              },
              {
                title: "ক্লাস শুরু",
                description:
                  "আমাদের কোচিং এর সময়সূচী অনুযায়ী আপনার সন্তানের ক্লাস শুরু করুন",
                icon: FaRegClock,
              },
            ].map((step, index) => (
            ...
            {[
              {
                ...
                answer:
                  "৮ম শ্রেণী থেকে দ্বাদশ শ্রেণী পর্যন্ত সকল শিক্ষার্থীদের জন্য আমাদের কোর্স এর বিশেষ ব্যবস্থা রয়েছে।",
              },
              {
              ...
              },
              {
                ...
                answer:
                  "আমাদের কোচিং এ ভর্তির জন্য শিক্ষার্থীর ২ কপি পাসপোর্ট সাইজ ছবি প্রয়োজন। শিক্ষার্থীর সাথে অবশ্যই অভিভাবককে আসতে হবে।",
              },
              {
                question: "অনলাইন ক্লাসের ব্যবস্থা আছে কি?",
                answer:
                  "হ্যাঁ, আমাদের রেকর্ডেড ক্লাসের ব্যবস্থা রয়েছে। বিশেষ করে যারা কোনো প্রয়োজনে কোনো এক দিনের ক্লাস করতে পারবেনা, তাদের জন্য আমাদের রেকর্ডেড ক্লাসের সুবিধা রয়েছে।",
              },
              {
